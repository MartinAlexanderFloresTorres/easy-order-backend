...
/**
 *
 * @param {*} { email, name, tokenRecoverPassword }
 * @description Genera un email para recuperar password
 * @example emailRecoverPassword({
 *  email: 'white@gmail.com',
 *  name: 'White Code',
 *  tokenRecoverPassword: 'SDAS213123QWEWQ213133123.SDF12123.AW',
 * })
 * @returns {boolean} true o false
 */

export const emailRecoverPassword = async ({ email, name, tokenRecoverPassword }) => {
  const HTML = `
  <!DOCTYPE html>
  <html lang="es">
    <head>
    ...
    <body>
      <div class="card">
        <div class="container" style="margin-bottom: 40px">
          <h2 style="text-transform: uppercase">Restablecer Contraseña</h2>
          <p>Hola ${name}, para restablecer tu contraseña, ingresa al siguiente enlace</p>
  
          <div style="margin: 20px 0">
            <a
              class="boton"
              style="text-align: center; min-width: fit-content; margin-bottom: 10px"
              href="${process.env.FRONTEND_URL}/auth/new-password/${tokenRecoverPassword}"
              target="_blank"
            >
          ...
          <p style="color: #ccc !important; font-size: 14px; text-align: center; line-height: 1.2">
            Si no has solicitado el restablecimiento de tu contraseña, puedes ignorar este correo.
          </p>
...
`;
  ...
  const msg = {
    ...
    subject: 'Restablecer Contraseña - Orden Facil',
    text: 'Orden Facil',
    html: HTML,
  };
  sgMail
